            ...
            <div className="px-[5%]">
              ...
              <ol className="list-decimal sm:text-lg font-medium flex gap-5 flex-col mt-14 px-[5%]">
                ...
                <li>
                  ...
                  friend, you EACH get a{" "}
                  <span className="font-bold">10% DISCOUNT</span> on your next
                  visit. Kindly request a referral card(s) from the front desk.
                </li>
                <li>
                  Kindly bring along your loyalty card to be signed off after
                  each visit so you can earn your{" "}
                  <span className="font-bold">10%</span> and{" "}
                  <span className="font-bold">20% DISCOUNT</span> on your 5th
                  and 10th appointment respectively. We appreciate your loyalty
                  and would like to “Thank you” with this{" "}
                  <span className="font-bold">Loyalty Plan</span>.
                </li>
                <li>
                ...
                <li>
                  For <span className="font-bold">Emergency Services</span> and{" "}
                  <span className="font-bold">Custom-Made Styles</span>, kindly
                  contact us to discuss an appointment.
                </li>
              </ol>
              <Link to="/booking">
