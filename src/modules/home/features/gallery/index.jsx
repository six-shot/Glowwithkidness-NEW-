...
//   return (
//     <div className="relative overflow-hidden my-[10vh]">
//       <motion.div
//         drag="x"
//         dragConstraints={{
//           left: 0,
...
//         onDragEnd={onDragEnd}
//         className="flex gap-8 cursor-grab items-center active:cursor-grabbing"
//       >
...
//           <div
//             key={idx}
//             className="flex flex-col items-center w-1/3 h-[500px] shrink-0"
//           >
//             <motion.div
//               style={{
...
//               }}
//               className="aspect-video w-full h-[500px]  object-cover"
//             />
//             {/* <motion.div
//               transition={SPRING_OPTIONS}
...
const imgs = [
  { src: "1a.jpg", text: "First Image" },
  { src: "1a.jpg", text: "Second Image" },
  { src: "1a.jpg", text: "Third Image" },
  { src: "1a.jpg", text: "Fourth Image" },
  { src: "1a.jpg", text: "Fifth Image" },
  { src: "1a.jpg", text: "Sixth Image" },
  { src: "1a.jpg", text: "Seventh Image" },
];
...
export const Gallery = () => {
  ...
  return (
    <div className="relative overflow-hidden py-8 mt-[13vh]">
      <motion.div
        drag="x"
        dragConstraints={{
          left: 0,
